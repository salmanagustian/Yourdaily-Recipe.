<template>
    <navbar>
        <div class="mr-auto cursor-pointer select-none">
            <router-link to="/">
                <span class="text-2xl font-light dark:text-white"
                    >Yourdaily 🍲</span
                >
                <br />
                <span class="text-3xl font-bold text-amber-400">Recipe.</span>
            </router-link>
        </div>
        <div class="flex items-center mr-5">
            ...
            <div
                data-placeholder
                class="mr-8 p-6 overflow-hidden relative bg-gradient-to-r bg-truGray-200 dark:bg-[#2e2e33] rounded-md"
                v-if="loading"
            ></div>
            ...
            <div
                data-placeholder
                class="p-6 overflow-hidden relative bg-gradient-to-r bg-truGray-200 dark:bg-[#2e2e33] rounded-md"
                v-if="loading"
            ></div>

            <div
                v-else
                class="relative px-4 py-3 bg-amber-100 dark:bg-[#2e2e33] rounded-xl"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                    ...
                    class="absolute top-[-10px] right-[-5px] px-2 py-1 text-white text-center text-xs bg-green-500 dark:bg-green-600 rounded-lg w-6"
                >
                    {{ bookmarkCount }}
                </div>
            </div>
